...
if __name__ == "__main__":
    ...
    dl_model(RVC_DOWNLOAD_LINK, "hubert_base.pt", BASE_DIR / "models/hubert")
    print("Downloading rmvpe.pt...")
    dl_model(RVC_DOWNLOAD_LINK, "rmvpe.pt", BASE_DIR / "models/rmvpe")
    print("Downloading vocals.onnx...")
    dl_model(
        RVC_DOWNLOAD_LINK + "uvr5_weights/onnx_dereverb_By_FoxJoy/",
        "vocals.onnx",
        BASE_DIR / "models/uvr5_weights/onnx_dereverb_By_FoxJoy",
    )

    rvc_models_dir = BASE_DIR / "models/pretrained"
    ...
    rvc_models_dir = BASE_DIR / "models/pretrained_v2"
    ...
    rvc_models_dir = BASE_DIR / "models/uvr5_weights"
